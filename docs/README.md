...
1. **物料範圍與屬性雙層過濾**：
   - 第一層保留原本品號前綴範圍：`M0`, `M2`, `E`, `K`（含小寫）。
   - 第二層再保留 `INVMB` 中 `品號屬性 (MB025)` 為 **"P" (代表：採購件)** 的物料，才進行 LeadTime 預測與 Recall 評估。
   - 非指定前綴或非採購件 (如自製件) 由於生產邏輯不同，不納入目前的採購延遲預測模型中。
...
<img width="1602" height="927" alt="image" src="https://github.com/user-attachments/assets/8cb9ff04-8c9a-4a58-931f-38e0f98112a4" />
<img width="1046" height="603" alt="image" src="https://github.com/user-attachments/assets/7c5258d7-dcbf-492e-85b9-4632c9626079" />

在物料庫存表中，能看到[製令單號]、[品號]、[預計用料]、[庫存數量]、[缺料狀態]、[缺料數量]等等資訊。
<img width="1037" height="602" alt="image" src="https://github.com/user-attachments/assets/3a27ad66-1f18-4d8e-b7d2-90e5da0349f2" />
<img width="1023" height="592" alt="image" src="https://github.com/user-attachments/assets/68feccf2-15fb-442b-ace2-379c96b57044" />
